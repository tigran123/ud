...
ПЯТОЕ ЭПОХАЛЬНОЕ\\
ОТКРОВЕНИЕ\\
\bibemph{иначе именуемое}\\
\titlefontsize
УРАНТИЙСКИЕ ДОКУМЕНТЫ\\
}%
\vspace*{\stretch{0.1}}
\bibemph{Перевод с английского\\под редакцией Тиграна Айвазяна}\\
\vspace*{\stretch{0.4}}
...
\upshape\normalsize\bfseries Вариант: \tunemarkup{pgnexus10}{10" цветной}\tunemarkup{pgthinmob}{20:9 цветной}\\
